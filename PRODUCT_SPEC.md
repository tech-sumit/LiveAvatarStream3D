...
> Scope note: this is an **internal tool**. There is intentionally no auth, multi-tenant isolation, consent/watermarking, billing, or public hardening in the current scope. Access is via VPN / port-forward for demos. Those are deferred, not designed out.
...
- Consent capture, watermarking, content moderation.
